...
Here's an example test: [The Ada Test](https://github.com/inclusive-teams/the-inclusive-team-tests/blob/master/the-ada-test.md
) after [Ada Lovelace](http://en.wikipedia.org/wiki/Ada_Lovelace).
